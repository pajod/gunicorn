...
from ssl import SSLContext, VerifyMode, _SSLMethod
...
@overload
def validate_if_no_app(val: None) -> None: ...
@overload
def validate_if_no_app(val: str) -> str: ...
...
class NewSSLContext(HookSetting):
    ...
    value: (
        Callable[[Config, type[SSLContext]], SSLContext] | None
    )  # FIXME: cannot be None
